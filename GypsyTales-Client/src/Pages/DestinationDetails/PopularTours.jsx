...
const PopularTours = ({location}) => {
    ...
    return (
        <div className='py-8 md:py-2 md:pt-0 md:mt-8 mt-2 pt-96 px-2'>
            <div className='flex justify-between'>
                <p style={{fontFamily : 'Chakra Petch'}} className='text-3xl dark:text-white md:px-4 font-bold font-serif py-4'>Popular Tours in <span className='text-red-600'> {destination.name}</span></p>
                <div>
                    <p className='flex gap-2 text-lg dark:text-white md:mr-8 font-semibold mt-8'>See All<FaArrowRight className='mt-1' /></p>
                </div>
            </div>
            <div className="carousel carousel-center w-full px-4 py-8 ">
                {
                    destination.popularTours.map(card => <div>
                        <div data-aos="fade-right" className='carousel-item px-2  relative h-[600px]'>
